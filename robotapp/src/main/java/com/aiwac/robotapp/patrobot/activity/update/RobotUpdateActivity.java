package com.aiwac.robotapp.patrobot.activity.update;
...
import com.aiwac.robotapp.patrobot.activity.update.http.OkGoUpdateHttpUtil;
import com.aiwac.robotapp.patrobot.activity.update.util.CProgressDialogUtils;
import com.aiwac.robotapp.patrobot.activity.update.util.HProgressDialogUtils;
...
public class RobotUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_robot_update);
...
//                .setAppKey("ab55ce55Ac4bcP408cPb8c1Aaeac179c5f6f")
                ...
                .checkNewApp(new UpdateCallback() {
                    ...
                    public void onBefore() {
                        CProgressDialogUtils.showProgressDialog(RobotUpdateActivity.this);
                    }
                    ...
                    @Override
                    public void onAfter() {
                        CProgressDialogUtils.cancelProgressDialog(RobotUpdateActivity.this);
                    }
                    ...
                    public void noNewApp(String error) {
                        Toast.makeText(RobotUpdateActivity.this, "没有新版本", Toast.LENGTH_SHORT).show();
                    }
                });
    }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (isShowDownloadProgress) {
                            updateAppManager.download(new DownloadService.DownloadCallback() {
                                @Override
                                public void onStart() {
                                    HProgressDialogUtils.showHorizontalProgressDialog(RobotUpdateActivity.this, "下载进度", false);
                                }
                                ...
                                public void onError(String msg) {
                                    Toast.makeText(RobotUpdateActivity.this, msg, Toast.LENGTH_SHORT).show();
                                    HProgressDialogUtils.cancel();
