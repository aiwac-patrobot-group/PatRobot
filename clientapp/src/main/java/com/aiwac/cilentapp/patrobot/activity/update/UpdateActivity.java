package com.aiwac.cilentapp.patrobot.activity.update;
...
import com.aiwac.cilentapp.patrobot.activity.update.http.OkGoUpdateHttpUtil;
import com.aiwac.cilentapp.patrobot.activity.update.util.CProgressDialogUtils;
import com.aiwac.cilentapp.patrobot.activity.update.util.HProgressDialogUtils;
...
//                .setAppKey("ab55ce55Ac4bcP408cPb8c1Aaeac179c5f6f")
                ...
                .checkNewApp(new UpdateCallback() {
                    ...
                    public void onBefore() {
                        CProgressDialogUtils.showProgressDialog(UpdateActivity.this);
                    }
                    ...
                    @Override
                    public void onAfter() {
                        CProgressDialogUtils.cancelProgressDialog(UpdateActivity.this);
                    }
                    ...
                    public void noNewApp(String error) {
                        Toast.makeText(UpdateActivity.this, "没有新版本", Toast.LENGTH_SHORT).show();
                    }
                });
    }
